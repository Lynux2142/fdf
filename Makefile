...
#    Updated: 2019/10/01 10:35:52 by lguiller         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS1			= main.c
SRCS1			+= ft_check_stock.c
SRCS1			+= ft_list.c
SRCS1			+= ft_draw.c
SRCS1			+= event_functions.c
SRCS1			+= ft_pixels.c
SRCS1			+= octan_part_one.c
SRCS1			+= octan_part_two.c
SRCS1			+= octan_part_three.c
SRCS1			+= octan_part_four.c
SRCS1			+= auto_function.c
